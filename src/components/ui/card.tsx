...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base leading-snug font-semibold tracking-normal text-slate-900 group-data-[size=sm]/card:text-sm dark:text-slate-100",
        className,
      )}
      {...props}
    />
